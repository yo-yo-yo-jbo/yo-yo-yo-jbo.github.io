...
- 🎉 CVEs
    ...
    - [CVE-2025-26729 - U-boot buffer overflow during symbolic link handling due to an integer overflow in allocation in the EroFS filesystem](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2025-26729)
    - [CVE-2025-0677 - GRUB2 buffer overflow during symbolic link handling due to an integer overflow in allocation in the JFS filesystem](https://access.redhat.com/security/cve/cve-2025-0677)
    - [CVE-2025-0678 - GRUB2 buffer overflow during file reads due to an integer overflow in allocation in the SquashFS filesystem](https://access.redhat.com/security/cve/cve-2025-0678)
    - [CVE-2025-0684 - GRUB2 buffer overflow during symbolic link handling due to an integer overflow in allocation in the ReiserFS filesystem](https://access.redhat.com/security/cve/cve-2025-0684)
    - [CVE-2025-0685 - GRUB2 buffer overflow during symbolic link handling due to an integer overflow in allocation in the RomFS filesystem](https://access.redhat.com/security/cve/cve-2025-0685)
    ...
    - [CVE-2025-0689 - GRUB2 buffer overflow during symbolic link handling due to an integer overflow in allocation in the UFS filesystem](https://access.redhat.com/security/cve/cve-2025-0689)
    ...
    - [CVE-2025-1125 - GRUB2 buffer overflow during file opens due to an integer overflow in allocation in the HFS filesystem](https://access.redhat.com/security/cve/cve-2025-1125)
