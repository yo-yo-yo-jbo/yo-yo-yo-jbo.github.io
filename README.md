...
- 🎉 CVEs
    ...
    - [CVE-2025-0677 - GRUB2 buffer overflow during symbolic link handling due to an integer overflow in the JFS filesystem](https://access.redhat.com/security/cve/cve-2025-0677)
    ...
    - [CVE-2025-0685 - GRUB2 buffer overflow during symbolic link handling due to an integer overflow in the RomFS filesystem](https://access.redhat.com/security/cve/cve-2025-0685)
    - [CVE-2025-0686 - GRUB2 buffer overflow during block reads due to an out-of-bounds operation in the UDF filesystem](https://access.redhat.com/security/cve/cve-2025-0686)
    - [CVE-2025-0689 - GRUB2 buffer overflow during symbolic link handling due to an integer overflow in the UFS filesystem](https://access.redhat.com/security/cve/cve-2025-0689)
