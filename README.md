...
- 🎉 CVEs
    ...
    - [CVE-2025-26724 - Barebox buffer overflow during symbolic link handling due to an integer overflow in the CramFS filesystem](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2025-26724)
    - [CVE-2025-26725 - Barebox buffer overflow during directory entry parsing in the JFFS2 filesystem](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2025-26725)
    - [CVE-2025-26726 - U-boot buffer overflow during directory table parsing in the SquashFS filesystem](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2025-26726)
    - [CVE-2025-26727 - U-boot buffer overflow during inode parsing in the SquashFS filesystem](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2025-26727)
    - [CVE-2025-26728 - U-boot buffer overflow during file reading in the SquashFS filesystem](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2025-26728)
    - [CVE-2025-26729 - U-boot buffer overflow during symbolic link handling due to an integer overflow in the EroFS filesystem](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2025-26729)
    - [CVE-2025-0677 - GRUB2 buffer overflow during symbolic link handling due to an integer overflow in the UFS filesystem](https://access.redhat.com/security/cve/cve-2025-0677)
    - [CVE-2025-0678 - GRUB2 buffer overflow during file reads due to an integer overflow in the SquashFS filesystem](https://access.redhat.com/security/cve/cve-2025-0678)
    - [CVE-2025-0684 - GRUB2 buffer overflow during symbolic link handling due to an integer overflow in the ReiserFS filesystem](https://access.redhat.com/security/cve/cve-2025-0684)
    - [CVE-2025-0685 - GRUB2 buffer overflow during symbolic link handling due to an integer overflow in the JFS filesystem](https://access.redhat.com/security/cve/cve-2025-0685)
    - [CVE-2025-0686 - GRUB2 buffer overflow during symbolic link handling due to an integer overflow in the RomFS filesystem](https://access.redhat.com/security/cve/cve-2025-0686)
    - [CVE-2025-0689 - GRUB2 buffer overflow during block reads due to an out-of-bounds operation in the UDF filesystem](https://access.redhat.com/security/cve/cve-2025-0689)
    ...
    - [CVE-2025-1118 - GRUB2 arbitrary memory read due to a misconfiguration of the dump command in Secure Boot environments](https://access.redhat.com/security/cve/cve-2025-1118)
    - [CVE-2025-1125 - GRUB2 buffer overflow during file opens due to an integer overflow in the HFS filesystem](https://access.redhat.com/security/cve/cve-2025-1125)
    ...
    - [CVE-2022-42821 - macOS AppleDouble-based Gatekeeper bypass](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2022-42821)
    ...
    - [CVE-2022-26706 - macOS stdin-based sandbox escape](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2022-26706)
    ...
    - [CVE-2021-30970 - macOS injection-based TCC bypass](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2021-30970)
    - [CVE-2021-30892 - macOS system_installd-based SIP bypass](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2021-30892)
